...
void addNewCat() {
  ...
  //} ELSE IF (E8. side EQUALS 1) {
    // E9. SETXY of cat to (RANDOM number between 20 and 480, width)
  //} ELSE IF (E10. side EQUALS 2) {
    // E11. SETXY of cat to (0, (RANDOM number between 20 and 480)
  //} ELSE IF (E12. side EQUALS 3) {
    // E13. SETXY of cat to (height, (RANDOM number between 20 and 480)
  // }
